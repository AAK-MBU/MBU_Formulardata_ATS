...
basisteam_spoergeskema_til_fagpe_mapping = {
    ...
    "spoergsmaal_fagperson_tabel": {
        ...
        "spg_fagperson_8": "Sparringsmøderne med Basisteam var brugbare",
    },
...
henvisningsskema_til_klinisk_hyp_mapping = {
    ...
    "uddyb_her_tvaergaaende_trivselsteam": "Uddyb her - Tværgående Trivselsteam",
    "uddyb_her_cool_kids_forloeb": "Uddyb her - Cool kids forløb",
    "uddyb_her_back2school": "Uddyb her - Back2School",
    "uddyb_her_center_for_trivsel": "Uddyb her - Center for Trivsel",
...
opfoelgende_spoergeskema_hypnote_mapping = {
    ...
    "spoergsmaal_foraelder_tabel": {
        "spg_foraelder_1": "Behandlingen hjalp mig (forælder)",
        "spg_foraelder_2": "Hvis en ven havde brug for denne form for hjælp, ville jeg anbefale vedkommende behandlingen (forælder)",
        "spg_foraelder_3": "Jeg følte mig passende informeret om meningen, formålet og forløbet af behandlingen",
        "spg_foraelder_4": "Vi har det bedre i familien nu, end før behandlingen begyndte (forælder)",
        "spg_foraelder_5": "Under behandlingen blev jeg i stand til at forandre min adfærd over for mit barn på en positiv måde",
        "spg_foraelder_6": "Under behandlingen opnåede jeg en bedre forståelse af mit barns psykiske tilstand",
        "spg_foraelder_7": "Jeg havde tillid til vores behandler",
        "spg_foraelder_8": "Behandlingen medførte, at mit barn fik det dårligere",
    },
...
foraelder_en_god_overgang_fra_hj_mapping = {
    ...
    "spoergsmaal_foraelder_tabel": {
        ...
        "spg_foraelder_6": "Jeg fik en bedre forståelse for, hvordan jeg støttede mit barn i opstarten",
...
fagperson_en_god_overgang_fra_hj_mapping = {
    ...
    "spoergsmaal_fagpersoner_tabel": {
        ...
        "spg_fagperson_3": "Overgangsmødet med forældre og vejledende sundhedsplejerske var meningsfuldt",
        "spg_fagperson_4": "Det tværfaglige samarbejde med vejledende sundhedsplejerske var meningsfuldt",
        "spg_fagperson_5": "Jeg fik en bedre forståelse for, hvordan barnet bedst blev støttet i opstarten",
...
ansoegning_om_koersel_med_skoleb_mapping = {
    "serial": "Serial number",
    "created": "Oprettet",
    "completed": "Gennemført",
    "navn_mitid": "Udfylder navn",
    "cpr_nummer_mitid": "Udfyler CPR-nummer",
    "er_du_foraeldremyndighedsindehaver_til_barnet_der_ansoeges_paa_v": "Er du forældremyndighedsindehaver til barnet der ansøges på vegne af?",
    "angiv_dine_kontaktoplysinger": "Kontaktoplysninger",
    "angiv_din_tilknytning_til_barnet": "Tilknytning til barnet",
    "barnets_navn_mitid": "Barnets navn",
    "cpr_nummer_barn_mitid": "Barnets CPR-nummer",
    "barnets_adresse_mitid": "Elevens adresse",
    "mit_barn_kommer_ikke_frem_i_listen": "Mit barn kommer ikke frem i listen",
    "barnets_navn_manuelt": "Barnets navn manuelt",
    "cpr_nummer_barn_manuelt": "Barnets CPR-nummer manuelt",
    "barnets_adresse_manuelt": "Elevens adresse manuelt",
    "barnet_skal_koeres_til_fra_anden_adresse": "Jeg ønsker at barnet bliver kørt til/fra en anden adresse end folkeregisteradresse",
    "barnets_anden_adresse": "Anden ønsket adresse",
    "begrundelse_for_valg_af_anden_adresse": "Begrundelse for valg af anden adresse",
    "barnets_skole": "Skole",
    "barnets_klassetrin": "Klassetrin",
    "vaelg_klassetype": "Klassetype",
    "langt_mellem_skole_og_hjem": "Mit barn har langt mellem skole og hjem",
    "trafikfarlig_vej": "Mit barn har en skolevej, som Aarhus Kommune har vurderet som trafikfarlig vej",
    "morgenkoersel": "Morgenkørsel",
    "eftermiddagskoersel": "Eftermiddagskørsel",
    "dato_for_foerste_koersel": "Dato for første kørsel",
    "skoleskema_kendes_ikke": "Skoleskema kendes ikke",
    "mandag_fra": "Mandag fra",
    "mandag_til": "Mandag til",
    "tirsdag_fra": "Tirsdag fra",
    "tirsdag_til": "Tirsdag til",
    "onsdag_fra": "Onsdag fra",
    "onsdag_til": "Onsdag til",
    "torsdag_fra": "Torsdag fra",
    "torsdag_til": "Torsdag til",
    "fredag_fra": "Fredag fra",
    "fredag_til": "Fredag til",
    "er_barnet_tilmeldt_sfo_": "Er barnet tilmeldt SFO?",
    "mandag__sfo": "Mandag sfo",
    "tirsdag__sfo": "Tirsdag sfo",
    "onsdag__sfo": "Onsdag sfo",
    "torsdag__sfo": "Torsdag sfo",
    "fredag__sfo": "Fredag sfo",
    "andre_relevante_oplysninger": "Andre relevante oplysninger",
    "jeg_giver_samtykke_til_at_der_maa_indhentes_oplysninger_om_mit_b": "Jeg giver samtykke til, at der må indhentes oplysninger om mit barn fra skole og andre afdelinger i Børn og Unge f.eks. PPR",
    "jeg_giver_samtykke_til_at_boern_og_unge_maa_dele_oplysninger_om": "Jeg giver samtykke til at Børn og Unge må dele oplysninger om mit barn med Familiecenteret i Sociale Forhold og beskæftigelse.",
}
